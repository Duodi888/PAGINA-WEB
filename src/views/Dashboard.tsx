  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        ...
        <button onClick={() => router.push('/projects')} className="btn-primary flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => router.push('/reports')} className="text-xs text-duodi-400 hover:text-duodi-300 flex items-center gap-1 font-semibold">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => router.push('/tasks')} className="text-xs text-duodi-400 hover:text-duodi-300 flex items-center gap-1 font-semibold">
          ...
          <div className="space-y-3">
            {urgentTasks.length === 0 ? (
              ...
              return (
                <button key={task.id} onClick={() => router.push('/tasks')} className="w-full text-left p-3 rounded-xl bg-brand-surface border border-red-900/30 hover:border-red-700/50 transition-colors">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => router.push('/projects')} className="text-xs text-duodi-400 hover:text-duodi-300 flex items-center gap-1 font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          {activeProjects.map((project) => {
            const client = clients.find((c) => c.id === project.clientId)
            return (
              <button key={project.id} onClick={() => router.push('/projects')} className="card-hover text-left">
